...
Generated: 2026-04-09T10:29:42.950943+00:00
Sampling method: lhs
...
| hard_perturbations | 0.250 | 11 | concise,indirect,colloquial,typo_noise,word_order,entity_swap_distractor |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| baseline | 1.000 | 0.268 [0.268, 0.268] | 0.282 | 0.661 | -7.656 [-7.656, -7.656] |

## Top Candidates

| Candidate | Frontier | Utility | Worst Slot Gain | Worst Keyword Gain | Flat Win Penalty |
| --- | --- | ---: | ---: | ---: | ---: |
| baseline | yes | 1.000 | 0.222 | 0.247 | -0.005 |
| candidate_0007 | no | 0.999 | 0.222 | 0.247 | -0.005 |
| candidate_0006 | no | 0.990 | 0.222 | 0.247 | -0.005 |
| candidate_0003 | no | 0.988 | 0.222 | 0.247 | -0.005 |
| candidate_0011 | no | 0.961 | 0.222 | 0.247 | -0.010 |
| candidate_0001 | no | 0.816 | 0.222 | 0.247 | -0.078 |
| candidate_0004 | no | 0.784 | 0.222 | 0.247 | -0.141 |
| candidate_0005 | no | 0.784 | 0.222 | 0.247 | -0.141 |
| candidate_0008 | no | 0.735 | 0.222 | 0.247 | -0.151 |
| candidate_0002 | no | 0.722 | 0.222 | 0.247 | -0.078 |
| candidate_0009 | no | 0.650 | 0.215 | 0.240 | -0.068 |
| candidate_0010 | no | 0.444 | 0.222 | 0.247 | -0.016 |

## Stability Report

- Mode count across runs: 2
- Average pairwise mode Jaccard: 0.000

| Mode | Appearance Rate | Run Count | Candidate Occurrences | Slot Gain Range | Token Delta Range |
| --- | ---: | ---: | ---: | ---: | ---: |
| mode_01 | 0.500 | 1 | 1 | 0.0000 | 0.0000 |
| mode_02 | 0.500 | 1 | 1 | 0.0000 | 0.0000 |
