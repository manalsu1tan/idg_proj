...
Generated: 2026-04-07T05:24:21.393528+00:00
Sampling method: lhs
...
| --- | ---: | ---: | ---: | ---: | ---: |
| baseline | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0001 | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0009 | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0013 | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0017 | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0018 | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0019 | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0020 | 0.969 | 0.146 [0.146, 0.146] | 0.133 | 0.500 | -3.250 [-3.250, -3.250] |
| candidate_0008 | 0.332 | 0.062 [0.062, 0.062] | 0.050 | 0.250 | -1.500 [-1.500, -1.500] |
| candidate_0012 | 0.332 | 0.062 [0.062, 0.062] | 0.050 | 0.250 | -1.500 [-1.500, -1.500] |

## Top Candidates

| Candidate | Frontier | Utility | Worst Slot Gain | Worst Keyword Gain | Flat Win Penalty |
| --- | --- | ---: | ---: | ---: | ---: |
| baseline | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0001 | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0009 | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0013 | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0017 | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0018 | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0019 | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0020 | yes | 0.969 | 0.146 | 0.133 | -0.000 |
| candidate_0002 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0003 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0005 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0006 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0007 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0010 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0011 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0014 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0015 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0016 | no | 0.765 | 0.146 | 0.133 | -0.250 |
| candidate_0004 | no | 0.668 | 0.146 | 0.133 | -0.250 |
| candidate_0008 | yes | 0.332 | 0.062 | 0.050 | -0.000 |
| candidate_0012 | yes | 0.332 | 0.062 | 0.050 | -0.000 |

## Stability Report

- Mode count across runs: 2
...
| --- | ---: | ---: | ---: | ---: | ---: |
| mode_01 | 1.000 | 3 | 23 | 0.0000 | 0.0000 |
| mode_02 | 1.000 | 3 | 7 | 0.0000 | 0.0000 |
