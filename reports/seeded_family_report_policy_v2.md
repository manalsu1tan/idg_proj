...
Generated: 2026-03-30T22:14:26.502349+00:00
...
- Scenario families: 5
- Hierarchy win rate: 0.250
- Flat win rate: 0.350
- Tie rate: 0.400
- Slot recall mean +/- stddev: baseline 0.767 +/- 0.311, hierarchy 0.842 +/- 0.212
- Keyword recall mean +/- stddev: baseline 0.717 +/- 0.289, hierarchy 0.804 +/- 0.203
- Retrieved tokens mean +/- stddev: baseline 13.9 +/- 1.6, hierarchy 22.8 +/- 7.0
- Average slot recall gain: 0.075
- Average keyword recall gain: 0.087
- Average retrieved token delta: -8.9

## Family Aggregates

| Family | Instances | Hierarchy Win Rate | Flat Win Rate | Slot Recall Gain | Token Delta |
| --- | ---: | ---: | ---: | ---: | ---: |
| commitment_revision | 4 | 0.250 | 0.750 | 0.000 | -17.2 |
| delayed_commitment | 4 | 0.000 | 0.000 | 0.000 | 0.0 |
| identity_shift | 4 | 0.000 | 1.000 | 0.000 | -11.8 |
...
| relationship_context__seed_11 | 11 | hierarchy | 0.250 | 0.500 | 13.0 | 29.0 |
| relationship_context__seed_23 | 23 | hierarchy | 0.250 | 0.500 | 13.0 | 28.0 |
| relationship_context__seed_37 | 37 | hierarchy | 0.250 | 0.750 | 13.0 | 28.0 |
| relationship_context__seed_53 | 53 | hierarchy | 0.250 | 0.750 | 13.0 | 29.0 |
| commitment_revision__seed_11 | 11 | flat | 1.000 | 1.000 | 15.0 | 27.0 |
| commitment_revision__seed_23 | 23 | flat | 1.000 | 1.000 | 13.0 | 31.0 |
| commitment_revision__seed_37 | 37 | hierarchy | 1.000 | 1.000 | 12.0 | 33.0 |
| commitment_revision__seed_53 | 53 | flat | 1.000 | 1.000 | 15.0 | 33.0 |
| identity_shift__seed_11 | 11 | flat | 0.667 | 0.667 | 12.0 | 24.0 |
| identity_shift__seed_23 | 23 | flat | 0.667 | 0.667 | 11.0 | 22.0 |
| identity_shift__seed_37 | 37 | flat | 0.333 | 0.333 | 17.0 | 29.0 |
| identity_shift__seed_53 | 53 | flat | 0.667 | 0.667 | 12.0 | 24.0 |
